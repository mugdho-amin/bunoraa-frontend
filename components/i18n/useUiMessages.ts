...
const FALLBACK_MESSAGES: Record<string, Partial<Record<UiNamespace, MessageMap>>> = {
  ...
  bn: {
    ...
    checkout: {
      ...
      processing_your_order: "আপনার অর্ডার প্রক্রিয়া করা হচ্ছে",
      processing_order_wait: "অনুগ্রহ করে অপেক্ষা করুন আমরা আপনার অর্ডার চূড়ান্ত করছি এবং আপনাকে রিডাইরেক্ট করছি।",
